...
import 'package:cloudplayplus/pages/diagnostics_inbox_page.dart';
...
import 'package:cloudplayplus/theme/theme_provider.dart';
import 'package:cloudplayplus/utils/navigation.dart';
            ...
            tiles: <SettingsTile>[
              ...
              if (AppPlatform.isDeskTop)
                SettingsTile.navigation(
                  ...
                  title: const Text('诊断收件箱目录'),
                  onPressed: (context) {
                    Navigation.navigateTo(
                      context: context,
                      screen: const DiagnosticsInboxPage(),
                      style: NavigationRouteStyle.cupertino,
                    );
                  },
                ),
