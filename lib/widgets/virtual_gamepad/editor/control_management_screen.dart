...
import 'package:cloudplayplus/utils/widgets/virtual_gamepad/control_base.dart';
import 'package:cloudplayplus/utils/widgets/virtual_gamepad/button_control.dart';
import 'package:cloudplayplus/utils/widgets/virtual_gamepad/joystick_control.dart';
import 'package:cloudplayplus/utils/widgets/virtual_gamepad/wasd_joystick_control.dart';
      ...
      child: GestureDetector(
        ...
        onPanUpdate: (details) {
          if (_isEditMode && _draggingControlId == control.id && 
            ...
            final clamped = clampControlCenterNorm(
              center: Offset(newCenterX, newCenterY),
              sizeNorm: control.size,
            );

            // 更新拖拽时的实时位置
            setState(() => _dragPositions[control.id] = clamped);
          }
        },
        onPanEnd: (details) {
          if (_isEditMode && _draggingControlId == control.id) {
            ...
            if (finalPosition != null) {
              final rounded = roundCenterNorm(finalPosition);
